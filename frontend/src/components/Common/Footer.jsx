		...
		<footer className='border-t py-12'>
				...
				<div>
					...
					<form className='flex'>
						<input
							...
							className='p-3 w-full border-t border-l border-b border-gray-300 rounded-l-d focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all'
							required
						/>
						<button
							type='submit'
							className='bg-black text-white px6 py-3 text-sm rounded-r-md hover:bg-gray-800 transition-all'>
							Subscribe
						</button>
					</form>
				</div>
			...
			<div className='container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-300 pt-6'>
				<p className='text-gray-500 text-sm tracking-tighter text-center'>
					&copy; 2025, Sadik.Dev. All Rights Reserved
				</p>
			</div>
		</footer>
	);
